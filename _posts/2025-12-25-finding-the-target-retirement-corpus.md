...
date: 2025-12-25
layout: post
title: Finding the target retirement corpus
updated: 2025-12-25
---
...
- Child Care cost
There will be other factors as well that need to be considered. Based on all my needs, let's assume that I would need ₹1,00,000 per month as expenses. Then, for an year, it would be ₹12,00,000. 
...
Third step is finding the inflation-adjusted annual expense at the year of retirement. Use an inflation calculator to find that value. Here are some of the example online calculators - [SBI](https://www.sbisecurities.in/calculators/inflation-calculator), [SEBI](https://investor.sebi.gov.in/calculators/inflation_calculator.html),  [Groww](https://groww.in/calculators/inflation-calculator)  that we can use. If we consider the data since 1960, India has seen an average inflation of 7.37% (source: [1](https://www.macrotrends.net/global-metrics/countries/ind/india/inflation-rate-cpi), [2](https://en.wikipedia.org/wiki/Inflation_in_India), [3](https://labourbureau.gov.in/rate-of-inflation)). If we consider recent trend, inflation in India is trending to be around 6-7%. In our example, the value of current expenses would be ₹12,00,000 rupees and let's take our annual inflation rate as 7% and time period would be 23 years. This would give a result of ₹56,88,636 (if 6% is considered then it would be ₹45,83,700). This means, we would need ₹56,88,636 at the age of 60 to meet the same expenses that we used to handle with ₹12,00,000 in the current year.
...
- [Balancing Acts: Safe Withdrawal Rates in the Indian Context - SSRN](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4697720)
- [Safe Withdrawal Rates in India (1992-2024) - SSRN](https://papers.ssrn.com/sol3/Delivery.cfm/5114252.pdf?abstractid=5114252)
- [Does the 4% Rule Work in India? - Arthgyaan](https://arthgyaan.com/blog/does-the-4-percent-rule-work-in-india.html)
- [Safe Withdrawal Rate India - Basunivesh](https://www.basunivesh.com/safe-withdrawal-rate-india/)
- US related - [Bengen (1994) - Determining Withdrawal Rates Using Historical Data](https://www.financialplanningassociation.org/sites/default/files/2021-04/MAR04%20Determining%20Withdrawal%20Rates%20Using%20Historical%20Data.pdf)
- US related - [Trinity Study (1998) - Retirement Savings: Choosing a Withdrawal Rate That Is Sustainable](https://www.aaii.com/files/pdf/6794_retirement-savings-choosing-a-withdrawal-rate-that-is-sustainable.pdf)
